...
import com.codegym.productmanagerment.service.ProductServiceImpl;
...
public class ProductServlet extends HttpServlet {
    ...
    private void listProducts(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (searchName != null && !searchName.isEmpty()) {
            products = this.productService.findByName(searchName);
        }
        else{
    ...
    private void createProduct(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        ...
        Product p = new Product(id, name, description, category, price, quantity, unit, brand, available, imageUrl);
